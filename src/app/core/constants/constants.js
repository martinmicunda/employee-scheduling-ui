...
export const USER_ROLES = Object.freeze({ADMIN: 'admin', MANAGER: 'manager', EMPLOYEE: 'employee'});
...
export const PROFILE_COMPLETENESS_TYPES = Object.freeze({ACCOUNT: 'account', EDIT_EMPLOYEE: 'edit-employee', ADD_EMPLOYEE: 'add-employee'});
